...
public class ExcelGenerator {
    ...
    public String generateMemberExcelFile(Long jobId){
        ...
        try(ExcelWriter ew = new ExcelWriter(1000, 1000)){
            ...
            s3StorageClient.uploadFile(s3Key, file);
     ...
     */
    @Transactional(readOnly = true)
    public String generateMemberExcelFileByMybatis(Long jobId) {
        ExcelJob job = excelJobRepository.findById(jobId)
                .orElseThrow(() -> new IllegalArgumentException("job not found:" + jobId));
